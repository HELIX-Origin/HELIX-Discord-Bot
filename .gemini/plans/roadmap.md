...
- [x] **DB-backed per-guild plugin repositories** — replace filesystem `git clone` installs with SQLite-stored, guild-scoped repos (Resolved [BUG-007](https://github.com/HELIX-Origin/HELIX-Discord-Bot/issues/13))
