...
- [BUG-022](.agents/bugs/BUG-022-guild-settings-registration-and-slash-purge.md) — Guild settings end-to-end bot state registration & stale slash command registry purge — **In Progress** (4 Sub-Tasks)
