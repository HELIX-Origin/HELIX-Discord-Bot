...
| **Rule 09** | GitHub-Flavored Mermaid & Diagram Standards | GitHub-compatible Mermaid syntax, one concern per diagram, legibility | [mermaid-standards.md](mermaid-standards.md) |
