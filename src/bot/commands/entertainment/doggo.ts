...
export const doggoCommandDef: ApplicationCommand = {
  name: 'doggo',
  description: 'Get a cute doggo GIF',
  options: [],
};

export async function handleDoggoCommand(
  ...
  const gifUrl = await client.getCategoryGif('doggo');
  if (!gifUrl) {
