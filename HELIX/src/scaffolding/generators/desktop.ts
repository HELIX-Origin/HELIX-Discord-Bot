...
version = "0.1.0"
description = "A Tauri App created with HELIX"
authors = ["HELIX"]
edition = "2021"
...
export default function App() {
  return (
    <div style={{ fontFamily: 'system-ui, sans-serif', padding: '2rem' }}>
      ...
      <p>Blazing fast native desktop application built with HELIX.</p>
    </div>
  );
}
`,
...
function createWindow() {
  ...
  win.loadURL('data:text/html,<html><body style="font-family:system-ui;padding:2rem;"><h1>${projectName}</h1><p>Electron Desktop Application (HELIX)</p></body></html>');
}
