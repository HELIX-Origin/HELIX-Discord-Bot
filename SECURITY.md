...
HELIX CLI follows semantic versioning. The following versions are currently supported with security updates:
...
- We will keep you updated on progress towards identifying and fixing the issue.
- Once fixed, a security advisory will be published and an updated release will be cut immediately.
