    ...
    <main class="flex-1 space-y-6">
      ...
      <section id="tab-overview" class="tab-content space-y-6">
        ...
        <div class="grid grid-cols-4 gap-4">
          ...
          <div class="glass p-5 rounded-2xl border border-gray-800">
            <span class="text-xs font-semibold uppercase text-gray-400 tracking-wider">Config Entries</span>
            <div class="text-3xl font-extrabold text-amber-400 mt-2">${dbStats.guildCount}</div>
            <span class="text-xs text-gray-500 mt-1 block">Guild configurations</span>
          </div>
        </div>
