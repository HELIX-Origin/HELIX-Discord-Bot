          ...
          <div id="scaffold-result" class="hidden p-5 rounded-2xl bg-gray-900/90 border border-gray-800 space-y-3">
            <div class="flex items-center justify-between">
              ...
              <div class="flex items-center gap-2">
                ...
                <a id="scaffold-download-btn" href="#" class="hidden px-3 py-1 rounded-lg bg-indigo-600 hover:bg-indigo-500 text-xs font-semibold text-white transition flex items-center gap-1.5 shadow-md shadow-indigo-600/20">
  ...
  <script>
    ...
    async function submitScaffold() {
      ...
      try {
        ...
        document.getElementById('scaffold-dryrun-badge').textContent = data.dryRun ? 'Dry-Run Preview' : 'Saved to Database';
        
        const dlBtn = document.getElementById('scaffold-download-btn');
        if (data.downloadUrl) {
          ...
          feedContainer.innerHTML = data.recentScaffolds.map(s => \`
            <div class="p-3 rounded-xl bg-gray-900/90 border border-gray-800/80 flex justify-between items-center hover:border-cyan-500/40 transition">
              ...
              <div class="flex items-center gap-3">
                ...
                <a href="/api/dashboard/scaffold/download?id=\${s.id}" class="p-1.5 rounded-lg bg-gray-800 hover:bg-cyan-600 text-gray-300 hover:text-white text-xs transition" title="Download ZIP Archive">
